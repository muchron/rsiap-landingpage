  <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
      @foreach ($articles['data']['articles'] as $item)
          <div class="flex bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden dark:bg-gray-800 dark:border-gray-700 m">
              <div class="w-1/3 flex-shrink-0">
                  <img class="w-full h-full object-cover aspect-square" src="{{ $item['cover'] }}" alt="{{ $item['title'] }}">
              </div>
