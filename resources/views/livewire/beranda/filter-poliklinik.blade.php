<div>
    <div class="relative mx-auto mt-6 px-4 lg:w-2/3 xl:w-1/2">
        ...
        <div class="relative bg-white dark:bg-gray-800 p-5 rounded-2xl border border-blue-100 dark:border-gray-700 shadow-xl shadow-blue-900/5">
            <div class="flex items-center gap-3 mb-5">
                <div class="flex-shrink-0 w-10 h-10 bg-blue-100 dark:bg-blue-900/30 rounded-xl flex items-center justify-center">
                    <i class="ri-search-eye-line text-blue-600 dark:text-blue-400 text-xl"></i>
                </div>
                <div>
                    <h1 class="text-lg font-bold text-gray-900 dark:text-white leading-tight">
                        Cari Jadwal <span class="text-blue-600">Poliklinik</span>
                    </h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div wire:ignore
                    ...
                    <div class="relative group">
                        <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none text-blue-500">
                            <i class="ri-calendar-2-line"></i>
                        </div>
                        <input id="default-datepicker" type="text" readonly
                            value="{{ $selectedDate }}"
                            class="bg-gray-50 dark:bg-gray-900/50 border border-gray-100 dark:border-gray-700 text-gray-900 dark:text-white text-sm rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 block w-full ps-9 p-2.5 transition-all cursor-pointer">
                    </div>
                </div>
                <div class="w-full">
                    <label class="block mb-1.5 text-[10px] font-bold uppercase tracking-wider text-gray-400">
                    ...
                    <div class="relative">
                        ...
                        <select wire:model.live="selectedDoctor" wire:change="changeDoctor"
                            class="bg-gray-50 dark:bg-gray-900/50 border border-gray-100 dark:border-gray-700 text-gray-900 dark:text-white text-sm rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 block w-full ps-9 p-2.5 appearance-none cursor-pointer">
            ...
            @for ($i = 0; $i < 4; $i++)
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-3 animate-pulse">
                    <div class="flex items-center gap-4">
                        <div class="flex-shrink-0 w-16 h-16 bg-blue-50 dark:bg-gray-700 rounded-xl"></div>
                        <div class="flex-1 space-y-2">
                            <div class="h-3 bg-gray-200 dark:bg-gray-700 rounded w-3/4"></div>
                            <div class="h-2 bg-blue-100 dark:bg-blue-900/30 rounded w-1/2"></div>
                        </div>
                    </div>
                        ...
                        <div wire:key="schedule-{{ $loop->index }}-{{ $item['slug'] ?? $loop->index }}"
                            ...
                            <div class="flex items-center gap-4">
                                <div class="flex-shrink-0">
                                    <img src="{{ $item['photo'] ?? 'https://ui-avatars.com/api/?name=' . urlencode($item['name']) . '&background=afd9ff&color=3b82f6' }}"
                                        alt="{{ $item['name'] }}"
                                        class="w-16 h-16 rounded-xl object-cover">
                                </div>

                                <div class="min-w-0 flex-1">
                                    <h3 class="text-sm font-bold text-gray-900 dark:text-white truncate group-hover:text-blue-600 transition-colors">
                                        {{ $item['name'] }}
                                    </h3>
                                    <p class="text-[10px] font-bold text-blue-600 dark:text-blue-400 uppercase tracking-tight truncate">
                                        {{ $item['polyclinic'] }}
                                    </p>

                                    <div class="mt-2 flex items-center gap-1.5 text-xs text-gray-500 dark:text-gray-400 font-medium">
                                        <i class="ri-time-fill text-blue-500 text-sm"></i>
                                        <span>
                            ...
                            <div class="mt-3">
                                ...
                                <a href="https://wa.me/628123456789?text={{ urlencode($pesanWa) }}"
                                    target="_blank"
                                    class="flex items-center justify-center w-full py-2 text-xs font-bold text-blue-700 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20 hover:bg-blue-600 hover:text-white dark:hover:bg-blue-600 dark:hover:text-white rounded-lg transition-all border border-blue-100 dark:border-blue-900">
