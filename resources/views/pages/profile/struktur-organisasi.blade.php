...
@section('content')
    <section class="relative py-12 overflow-hidden bg-white dark:bg-gray-800">
        <div class="absolute inset-0 z-0">
            <div class="absolute inset-0 bg-gradient-to-br from-gray-100 via-blue-50/30 to-gray-200 dark:from-gray-950 dark:via-blue-950/20 dark:to-slate-950"></div>
            ...
            <div class="absolute -top-24 -left-24 w-[300px] md:w-[600px] h-[300px] md:h-[600px] bg-gradient-to-r from-blue-400/20 to-transparent dark:from-blue-500/10 rounded-full blur-[120px] animate-pulse"></div>
            <div class="absolute bottom-0 right-0 w-[250px] md:w-[500px] h-[250px] md:h-[500px] bg-gradient-to-l from-blue-300/10 to-transparent dark:from-blue-500/5 rounded-full blur-[100px]"></div>
        </div>
        ...
        <div class="container relative z-10 mx-auto px-4 max-w-6xl">
            ...
            <div class="relative group p-8">
                <div class="absolute inset-0 bg-blue-500/5 blur-3xl rounded-full scale-90 pointer-events-none"></div>

                <img src="{{ asset('images/struktur-organosasi-2025.png') }}"
                    alt="Struktur Organisasi RSIA Aisyiyah Pekajangan"
                    class="relative z-10 w-full h-auto rounded-2xl dark:invert transition-all duration-500 group-hover:scale-[1.02]">
            </div>
        </div>
    </section>

    {{-- 2. Section Tambahan: Visi & Informasi (Diletakkan di bawah gambar) --}}
    <section class="py-20 bg-blue-100 dark:bg-gray-950 transition-colors duration-500">
        <div class="container mx-auto px-4 max-w-5xl">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                ...
                <div class="flex flex-col justify-center space-y-4">
                    <h3 class="text-2xl font-black text-blue-800 dark:text-white uppercase tracking-normal ">Tata Kelola Terpadu</h3>
                    ...
                    <div class="flex gap-2">
                        ...
                        <span class="px-3 py-1 bg-blue-200 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 text-[10px] font-bold rounded-full uppercase shadow-md">Islami</span>
                    </div>
                </div>
            </div>
        </div>
